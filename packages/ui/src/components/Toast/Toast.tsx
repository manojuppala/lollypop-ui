...
const toastVariants = tv({
  base: [
    ...
    'space-x-3 overflow-hidden rounded-md border p-4 pr-6 shadow-lg transition-all',
  ...
  variants: {
    variant: {
      ...
      error: 'border-error-600 bg-error-50 text-error-900',
      info: 'border-primary-600 bg-primary-50 text-primary-900',
    },
  },
  defaultVariants: {
    variant: 'default',
